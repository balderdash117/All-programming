...
namespace Snakes_and_Ladders
{
    public partial class Form1 : Form
    {
        ...
        PlayerClass[] TurnPlayer = new PlayerClass[4];
        ...
        private void moveplayer(int whoturn, int rollingdie)
        {
            ...
            //MyBoard[53].Image = PlayerPic1.Image;
        ...
        {          
            ...
            TurnPlayer[0] = Player1;
            TurnPlayer[1] = Player2;
            TurnPlayer[2] = Player3;
            TurnPlayer[3] = Player4;
        }
