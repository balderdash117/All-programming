...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
////																									
////		Name:		Console window routines															
////																									
////		Purpose:	window.cpp																	
////																									
////		Author:		John Pelkman	27/2/2017																	
////																									
////////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "window.h"
#include "string.h"
...
bool Window::Initialise(int a_width, int a_height, char *name)
{
...
// draw a character at position (ax, ay)
void Window::DrawChar(int a_x, int a_y, unsigned char a_char)
{
	...
	// if ok the print the character
	if (SetXY(a_x, a_y)) 
		cout << a_char;
}

// draw a text line block at position (x, y) in color at block width (a_max)
void Window::DrawTextLine(int a_x, int a_y, eColor a_color, char *a_line, int a_max)
{
	// what, no line?
	if (a_line == nullptr) return;
	// if the first character is out of bounds then return
	if (a_x < 0 || a_x > mScreenWidth || a_y < 0 || a_y > mScreenHeight)
		return;
	...
	while (true) {
		...
		for (int k = charCount; a_line[k] != '\0'; ++k) {
			if (k >= doBreak) break;
