...
enum eColor { BLACK, DARKBLUE, DARKGREEN, DARKCYAN, DARKRED, DARKMAGENTA, DARKYELLOW, LIGHTGRAY, GRAY, BLUE, GREEN, CYAN, RED, MAGENTA, YELLOW, WHITE };
...
{
public:
	bool Initialise(int a_width, int a_height, wchar_t *name);
