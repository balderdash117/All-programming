...
Townspeople::Townspeople() : GameObject(), force(1000.f), m_graph(nullptr),
...
void Townspeople::update(float deltaTime)
{
	...
	if (input->wasMouseButtonPressed(aie::INPUT_MOUSE_BUTTON_MIDDLE) || input->wasKeyPressed(aie::INPUT_KEY_ENTER))
	{
