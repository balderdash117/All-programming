...
void LinkedLists::initializeNode()
{
...
void LinkedLists::eraseLinkedList() {
...
void LinkedLists::changeMenu(bool up) 
{
	switch (menuItem) {
	case NAME:
...
void LinkedLists::update(float deltaTime) {
	// input example
